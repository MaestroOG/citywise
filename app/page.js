...
import { getWeatherForCity, getCityImage, get7DayWeather, getLifeStyleTips, kelvinToCelsius } from "@/lib/weather"
  ...
  return (
    <main className="lg:px-40 py-5">
      ...
      <Container className={'mt-5 w-[95vw] mx-auto'}>
        ...
        {weather?.name && <LifestyleTips temperature={kelvinToCelsius(weather?.main.temp)} />}
